...
public class LandscapeListAdapter extends ArrayAdapter<Category>
{
    /** Current context */
    ...
    public LandscapeListAdapter(Context context, ArrayList<Category> contentList)
    {
    ...
    {
        View v = convertView;
        LandscapeListAdapter.CategoryHolder holder;
        if (v == null)
        {
            LayoutInflater vi = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            v = vi.inflate(R.layout.list_item, null);
            holder = new LandscapeListAdapter.CategoryHolder(v);
            v.setTag(holder);
        }
        else
        {
            holder= (LandscapeListAdapter.CategoryHolder)v.getTag();
            if(holder == null)
            {
                holder = new LandscapeListAdapter.CategoryHolder(v);
                v.setTag(holder);
